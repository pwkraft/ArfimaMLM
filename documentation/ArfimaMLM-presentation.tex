...
\usepackage{lmodern} % to fix fint size error, might be problematic with math symbols
\usepackage{array}
\usepackage{amsmath}
\usepackage{dcolumn}
...
% Date and time: Fri, Jan 30, 2015 - 04:59:27 PM
...
% Table created by stargazer v.5.1 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Fri, Jan 30, 2015 - 04:59:32 PM
% Requires LaTeX packages: dcolumn 
\begin{table}[!htbp] \centering 
